...
public class PrintHTML {
	...
	public void printFooter(ServletOutputStream out) throws IOException{
		out.println("</div></div></div></div><footer class='section section-success' style='position: absolute; bottom: 0;width:100%'>"
				+ "<div class='container'>"
				+ "<div class='row'>"
				+ "<div class='col-sm-6'>"
				+ "<h1>Created by</h1>"
				+ "<p>Julien Moulin</p>"
				+ "<p>Ousmane Sow Thierno</p>"
				+ "<p>M1 MIAGE - TP SIR</p>"
				+ "</div>"
				+ "<div class='col-sm-6'>"
				...
				+ "<a href='https://github.com/julienmoulinSIR'><i class='fa fa-3x fa-fw fa-github text-inverse'></i></a>"
				+ "</div>"
				+ "</div>"
				+ "<div class='row'>"
